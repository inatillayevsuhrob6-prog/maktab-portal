...
def create_app():
    ...
    def ask_ai_chat_stream():
        ...
        try:
            ...
            response = client.chat.completions.create(model="llama3-70b-8192", messages=[{"role": "system", "content": "Siz maktab o'quvchilari uchun mehribon AI yordamchisiz. Qisqa va aniq javob bering."}, {"role": "user", "content": user_message}])
